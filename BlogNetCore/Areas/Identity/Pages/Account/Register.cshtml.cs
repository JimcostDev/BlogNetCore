    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //Aquí valiamos si los roles existen sino se crean (sino existen entra al if)
                    ...
                    //obtener el rol seleccionado desde el formulario register
                    ...
                    await _signInManager.SignInAsync(user, isPersistent: false);//agregar user a db
